...
#填写API
Sys.setenv(OPENAI_API_KEY = 'sk-151fc404cea5416799703c09f0c0ed3d')
#填写API调用网址
...
#注释后可视化
pdf(file = "1.deepseek注释UMAP.pdf",width =7.5,height = 5.5)
...
dev.off()
pdf(file = "2.deepseek注释TSEN.pdf",width =7.5,height = 5.5)
...
dev.off()
qsave(scRNA,"deepseek注释.qs",nthreads = detectCores())
####################################################
#######欢迎关注《叉叉滴同学的生信笔记》#########
#######欢迎关注《叉叉滴同学的生信笔记》#########
#######欢迎关注《叉叉滴同学的生信笔记》#########
